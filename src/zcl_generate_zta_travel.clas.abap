CLASS zcl_generate_zta_travel DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_zta_travel IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF zta_travel.
...
*   delete existing entries in the database table
    DELETE FROM zta_travel.

*   insert the new table entries
    INSERT zta_travel FROM TABLE @itab.
